...
const SCOUT_SKILLS_DATA = [
  ...
  // ==========================================
  {
    ...
    shortDescription: "Chọn vị trí, trải lều, dựng khung, đóng cọc và căng dây để lều ổn định, khô ráo và an toàn.",
    environment: "outdoor",
    difficulty: "medium",
    tags: ["Lều trại", "Dã ngoại", "Nút dây", "Leave No Trace"],
    media: { poster: "", videoId: "2J4jZJ4s2L8" },
...

  {
    id: "sk-chon-dat-trai",
    slug: "chon-dat-trai",
    title: "2. Chọn đất trại",
    title_en: "Site Selection for Campgrounds",
    category: "da-ngoai-trai",
    subcategory: "Đất trại & Bãi cắm",
    shortDescription: "Biết quan sát địa hình để tìm khu vực bằng phẳng, thoát nước, tránh cây nguy hiểm và các khu vực có nguy cơ ngập.",
    environment: "outdoor",
    difficulty: "medium",
...

  {
    ...
    slug: "xep-ba-lo",
    title: "3. Xếp ba lô",
    title_en: "Backpack Packing & Weight Distribution",
    category: "da-ngoai-trai",
    subcategory: "Hành trang & Ba lô",
    shortDescription: "Sắp xếp hành trang cân bằng, chống ướt và lấy được vật dụng cần thiết nhanh chóng.",
    environment: "both",
    difficulty: "easy",
...

  {
    ...
    title_en: "Trail Trekking & Hiking Expedition",
    category: "da-ngoai-trai",
    subcategory: "Đi bộ đường dài",
    shortDescription: "Điều chỉnh tốc độ, giữ đội hình, nghỉ hợp lý, sử dụng nước và xử lý các vấn đề thường gặp khi trekking.",
    environment: "outdoor",
    difficulty: "medium",
    tags: ["Hiking", "Thám du", "Dã ngoại", "Outdoor", "Địa hình"],
    media: { poster: "image/kynang/5-khu-vuc-di-bo-duong-dai.png", videoId: "" },
...

  {
    ...
    title_en: "Camp Strike & Leave No Trace Principles",
    category: "da-ngoai-trai",
    subcategory: "Kỷ luật đất trại",
    shortDescription: "Thu gom vật dụng và rác, xử lý khu bếp và hoàn trả khu vực gần với trạng thái ban đầu nhất.",
    environment: "outdoor",
    difficulty: "easy",
...

  {
    ...
    title_en: "Clove Hitch",
    category: "scoutcraft",
    subcategory: "Nút dây cơ bản",
    shortDescription: "Khởi đầu hoặc cố định dây vào cọc/cây trong nhiều công việc trại và ráp nối tiên phong.",
    environment: "both",
    difficulty: "easy",
    tags: ["Nút dây", "Pioneering", "Scoutcraft"],
    media: { poster: "", videoId: "" },
...

  {
    ...
    shortDescription: "Chọn vị trí, chuẩn bị khu vực, nhóm và kiểm soát một đống lửa nhỏ.",
    environment: "outdoor",
    difficulty: "medium",
...

  {
    ...
    title_en: "Silva Compass Anatomy & Usage",
    category: "kham-pha-dinh-huong",
    subcategory: "Phương hướng & La bàn",
    shortDescription: "Nhận biết cấu tạo đĩa xoay 360 độ, kim từ tính và xác định hướng di chuyển chính xác.",
    environment: "outdoor",
    difficulty: "medium",
...

  {
    ...
    title_en: "Hypothermia Symptoms & Field Treatment",
    category: "so-cuu-an-toan",
    subcategory: "Thời tiết & Môi trường",
    shortDescription: "Nhận biết sớm các dấu hiệu nguy hiểm khi cơ thể mất nhiệt (dưới 35°C), cách ly nguồn lạnh và làm ấm vùng lõi đúng cách.",
    environment: "both",
    difficulty: "medium",
    tags: ["Hạ thân nhiệt", "Sơ cứu", "Mùa đông", "Sinh tồn"],
    media: { poster: "image/kynang/ha-than-nhiet-so-cuu.png", videoId: "" },
